...
st.markdown("<h1 style='text-align: center; color: blue;'><u>Analysing Stock Prices for different companies</u></h1>", unsafe_allow_html=True)
st.sidebar.markdown("<h3 style='text-align: center; color: blue;'><u>Input features given by the user</u></h3>", unsafe_allow_html=True)
